...
# ========== 在 import unsloth 之前 patch accelerate ==========
import accelerate
# 1. 禁用 device_map 验证
accelerate.Accelerator.verify_device_map = lambda self, model: False
# 2. 直接短路 prepare_model，跳过所有检查（is_loaded_in_4bit/8bit、device_map等）
accelerate.Accelerator.prepare_model = lambda self, model, device_placement=None, evaluation_mode=False: model
print(">>> accelerate prepare_model 已短路")
# ============================================================================

# ========== 禁用 transformers Trainer 的 _move_model_to_device ==========
transformers.Trainer._move_model_to_device = lambda self, model, device: None
print(">>> transformers Trainer._move_model_to_device 已禁用")
# ============================================================================
...
# ========== 禁用 Unsloth fix_untrained tokens ==========
