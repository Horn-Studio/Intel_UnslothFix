...
# ========== Patch Intel Arc A770（必须在 import unsloth 之前）==========
...
# ========== 配置 ==========
CONFIG = {
    "model_path": "/mnt/h/Qwen3-8B-unsloth-bnb-4bit",
    "dataset_path": "/mnt/d/xiaoh_qa_dataset_10k_expanded.json",
    "output_dir": "/mnt/h/unsloth_train/outputs",
    "max_seq_length": 1024,
    "lora_r": 16,
    "lora_alpha": 16,
    "learning_rate": 2e-4,
...
model.save_pretrained_merged(CONFIG["output_dir"], tokenizer)
